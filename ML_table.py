...
#    clearsight=clearsight_final.regnum()
    ...
    if 1<Purchase_Score<=300:
        ...
        PurchaseRating=0 
    score=scorebeneish+scorebrad1+scorebrad2+scorez+CreditRating+PurchaseRating
    if score==0 or score==1 or score==2 or score==3 or score==4:
        cls=0
    else:
        cls=1
